...
on_fluo = true; # are we on Fluo server?
...
co2_isobar = 1e6*result.x["CO2"] ./ vcd
println(co2_isobar)


@save "CO2_isobar.jld2" result p0 T0 xₐ vcd x_true co2_isobar n
...
h2o_degrees = DOF(result, h2o_ind)
@show h2o_degrees 
